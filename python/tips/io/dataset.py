...
class Dataset:
    def __init__(self, generator=None, indexer=None, meta=None):
        ...
        indexer that returns a datum given its index. The meta (metadata)
        contains the size and data format of the dataset.
        """
        self.meta = meta
 ...
 spec:
    ...
    def skim(self, check_elem=True):
        ...
        Args:
           check_elem (bool): check whether the elements in the ds agrees with metadata
    ...
    def convert(self, *args, fmt=None, **kwargs):
        ...
        Args:
           fmt (str): target format as defined in tips.io.convertors

        Returns:
           (any): dependent on the convertor
        """
    ...
    def subsample(self, strategy, nsample=None, psample=None, sort_key="force_std"):
        ...
        Returns:
            (np.array): inidices of the selected samples
            (Dataset): a TIPS Dataset
        """
        import math
        import numpy as np
    ...
    def map_elems(self, emap):
        ...
        Args:
            emap (str, dict): a dict or a LAMMPS data file
